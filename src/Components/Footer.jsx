      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/3 mb-6">
            <h3 className="text-xl font-bold mb-2"><img src="/Brand3.png" alt="" /></h3>
            <p>
            Shopy Glob – Your Global Destination for Trendy Shopping!
            </p>
          </div>
          ...
          <div className="w-full md:w-1/3 mb-6">
            ...
            <ul>
              ...
              <li className="mb-2"><Link to="/CategoryProductPage/All" className="hover:text-gray-400">Products</Link></li>
              <li className="mb-2"><Link to="" className="hover:text-gray-400">Profile</Link></li>
              <li className="mb-2"><Link to="/CartPage" className="hover:text-gray-400">Cart</Link></li>
            </ul>
          </div>
