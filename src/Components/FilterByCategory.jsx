  ...
  return (
    <div className=" ">
      <div className=" flex gap-2">
        ...
        <select name="categoryFilter" id="categoryFilter" className="bg-white border outline-none rounded-sm" defaultValue="All" onChange={(e)=>HandleCategory(e.target.value)}>
          <option value="All">All</option>
          {UniqueCategoryProducts?.map((item, index) => (
